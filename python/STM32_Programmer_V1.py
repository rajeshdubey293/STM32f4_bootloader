...
COMMAND_BL_BOOT_APPLICATION_1                       = 0x5D
COMMAND_BL_BOOT_APPLICATION_2                       = 0x5E
...
COMMAND_BL_BOOT_LEN_APPLICATION_1                   = 8
COMMAND_BL_BOOT_LEN_APPLICATION_2                   = 8
...
def process_COMMAND_BL_BOOT_APPLICATION_1(length):
    pass
def process_COMMAND_BL_BOOT_APPLICATION_2(length):
    pass
...
def decode_menu_command_code(command):
    ...
    if(command  == 0 ):
        ...
        print("\n   Command == > COMMAND_BL_BOOT_APPLICATION_1 ")
        data_buf[0] = COMMAND_BL_BOOT_LEN_APPLICATION_1 - 1 
        data_buf[1] = COMMAND_BL_BOOT_APPLICATION_1 
        crc32       = get_crc(data_buf,COMMAND_BL_BOOT_LEN_APPLICATION_1 - 4) 
        data_buf[2] = word_to_byte(crc32,1,1) 
        data_buf[3] = word_to_byte(crc32,2,1) 
        data_buf[4] = word_to_byte(crc32,3,1) 
        data_buf[5] = word_to_byte(crc32,4,1) 
        ...
        for i in data_buf[1:COMMAND_BL_BOOT_LEN_APPLICATION_1]:
            Write_to_serial_port(i,COMMAND_BL_BOOT_LEN_APPLICATION_1 - 1)
         
        ret_value = read_bootloader_reply(data_buf[1])
    elif(command == 15):
        print("\n   Command == > COMMAND_BL_BOOT_APPLICATION_2 ")
        data_buf[0] = COMMAND_BL_BOOT_LEN_APPLICATION_2 - 1 
        data_buf[1] = COMMAND_BL_BOOT_APPLICATION_2 
        crc32       = get_crc(data_buf,COMMAND_BL_BOOT_LEN_APPLICATION_2 - 4) 
        data_buf[2] = word_to_byte(crc32,1,1) 
        data_buf[3] = word_to_byte(crc32,2,1) 
        data_buf[4] = word_to_byte(crc32,3,1) 
        data_buf[5] = word_to_byte(crc32,4,1) 
        ...
        for i in data_buf[1:COMMAND_BL_BOOT_LEN_APPLICATION_2]:
            Write_to_serial_port(i,COMMAND_BL_BOOT_LEN_APPLICATION_2 - 1)
...
def read_bootloader_reply(command_code):
    ...
    if(len(ack) ):
        ...
        if (a_array[0]== 0xA5):
            ...
            elif(command_code) == COMMAND_BL_BOOT_APPLICATION_1:
                process_COMMAND_BL_BOOT_APPLICATION_1(len_to_follow)
            elif(command_code) == COMMAND_BL_BOOT_APPLICATION_2:
                process_COMMAND_BL_BOOT_APPLICATION_2(len_to_follow)
...
while True:
    ...
    print("   BL_BOOT_APPLICATION_1                 --> 14")
    print("   BL_BOOT_APPLICATION_2                 --> 15")
    print("   MENU_EXIT                             --> 0")
